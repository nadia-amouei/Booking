 ...
 */
class getMessenger_Transport_RabbitmqService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.rabbitmq' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.rabbitmq'] = (new \Symfony\Component\Messenger\Transport\TransportFactory(new RewindableGenerator(function () use ($container) {
        ...
        }, 2)))->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN'), ['transport_name' => 'rabbitmq'], new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer());
    }
}
