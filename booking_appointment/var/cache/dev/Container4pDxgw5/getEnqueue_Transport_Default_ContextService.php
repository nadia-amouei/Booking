...
class getEnqueue_Transport_Default_ContextService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['enqueue.transport.default.context'] = ($container->privates['enqueue.transport.default.connection_factory'] ?? $container->load('getEnqueue_Transport_Default_ConnectionFactoryService'))->createContext();
    }
}
