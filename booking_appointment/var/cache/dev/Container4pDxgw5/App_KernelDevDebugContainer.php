...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Hydra/State/Util/SearchHelperTrait.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/State/Util/StateOptionsTrait.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Hydra/Serializer/CollectionFiltersNormalizer.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Hydra/State/Util/PaginationHelperTrait.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Resource/Factory/PhpFileResourceNameCollectionFactory.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Extractor/PhpFileResourceExtractor.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Resource/Factory/MutatorResourceMetadataCollectionFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Mutator/ResourceMutatorCollectionInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Mutator/ResourceMutatorCollection.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Mutator/OperationMutatorCollectionInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Mutator/OperationMutatorCollection.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Metadata/Resource/Factory/PhpFileResourceMetadataCollectionFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Validator/Util/ParameterValidationConstraints.php';
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6DWDqZ1GIP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0Jl60M1vBR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LQ+xPXOL16', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $b = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(($container->privates['doctrine.debug_data_holder'] ??= new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder($container->parameters['enqueue.transports'])), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.terminate', [#[\Closure(name: 'enqueue.client.default.flush_spool_producer_listener', class: 'Enqueue\\Symfony\\Client\\FlushSpoolProducerListener')] fn () => ($container->privates['enqueue.client.default.flush_spool_producer_listener'] ?? $container->load('getEnqueue_Client_Default_FlushSpoolProducerListenerService')), 'flushMessages'], 0);
        $instance->addListener('console.terminate', [#[\Closure(name: 'enqueue.client.default.flush_spool_producer_listener', class: 'Enqueue\\Symfony\\Client\\FlushSpoolProducerListener')] fn () => ($container->privates['enqueue.client.default.flush_spool_producer_listener'] ?? $container->load('getEnqueue_Client_Default_FlushSpoolProducerListenerService')), 'flushMessages'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\AppointmentController', 'App\\Controller\\AuthController', 'App\\Controller\\PaymentController', 'App\\Controller\\ServiceController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator.plrhKmk' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_PlrhKmkService($container)
    {
        return $container->privates['.service_locator.plrhKmk'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['security.user.provider.concrete.users_in_memory'] ??= new \Symfony\Component\Security\Core\User\InMemoryUserProvider([]));
    ...
    {
        $a = ($container->privates['.service_locator.plrhKmk'] ?? self::get_ServiceLocator_PlrhKmkService($container));
    ...
    protected static function getSerializerService($container)
    {
        ...
        $e = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $b, $c)], [$d])), $container->parameters['api_platform.serializer.default_context']), $container->parameters['api_platform.serializer.default_context']);
