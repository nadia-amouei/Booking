...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'enqueue.transport.consume_command' => ['privates', 'enqueue.transport.consume_command', 'getEnqueue_Transport_ConsumeCommandService', true],
            'enqueue.client.consume_command' => ['privates', 'enqueue.client.consume_command', 'getEnqueue_Client_ConsumeCommandService', true],
            'enqueue.client.produce_command' => ['privates', 'enqueue.client.produce_command', 'getEnqueue_Client_ProduceCommandService', true],
            'enqueue.client.setup_broker_command' => ['privates', 'enqueue.client.setup_broker_command', 'getEnqueue_Client_SetupBrokerCommandService', true],
            'enqueue.client.routes_command' => ['privates', 'enqueue.client.routes_command', 'getEnqueue_Client_RoutesCommandService', true],
            ...
            'maker.auto_command.make_state_processor' => ['privates', '.maker.auto_command.make_state_processor.lazy', 'get_Maker_AutoCommand_MakeStateProcessor_LazyService', true],
            'maker.auto_command.make_state_provider' => ['privates', '.maker.auto_command.make_state_provider.lazy', 'get_Maker_AutoCommand_MakeStateProvider_LazyService', true],
            'maker.auto_command.make_filter' => ['privates', '.maker.auto_command.make_filter.lazy', 'get_Maker_AutoCommand_MakeFilter_LazyService', true],
        ], [
