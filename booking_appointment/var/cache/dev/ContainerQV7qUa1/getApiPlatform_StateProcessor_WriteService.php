...
class getApiPlatform_StateProcessor_WriteService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/State/Util/HttpResponseHeadersTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/State/Util/HttpResponseStatusTrait.php';
