...
class DefaultsConfig 
{
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('strict_query_parameter_validation', $value)) {
            $this->_usedProperties['strictQueryParameterValidation'] = true;
            $this->strictQueryParameterValidation = $value['strict_query_parameter_validation'];
            unset($value['strict_query_parameter_validation']);
        }

        if (array_key_exists('hide_hydra_operation', $value)) {
            $this->_usedProperties['hideHydraOperation'] = true;
            $this->hideHydraOperation = $value['hide_hydra_operation'];
            unset($value['hide_hydra_operation']);
        }

        if (array_key_exists('json_stream', $value)) {
            $this->_usedProperties['jsonStream'] = true;
            $this->jsonStream = $value['json_stream'];
            unset($value['json_stream']);
        }
